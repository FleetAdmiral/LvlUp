...
export class IndividualSellersHubPage extends Component {
	constructor () {
		super();
	}
...
export const IndividualSellersHubPageContainer = createContainer(function(props) {
